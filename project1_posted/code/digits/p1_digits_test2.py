...
projected_data = mapper.fit_transform(data,
                                      projection=sklearn.manifold.SpectralEmbedding(n_components=3, 
...
mapper.visualize(graph,
                 path_html="keplermapper_digits_custom_tooltips_test2.html",
                 graph_gravity=0.25,
                 custom_tooltips=tooltip_s)
# Tooltips with the target y-labels for every cluster member
mapper.visualize(graph,
                 path_html="keplermapper_digits_ylabel_tooltips_test2.html",
                 graph_gravity=0.25,
